...
static char FB_API_URI[] = "https://graph.facebook.com/262705202274751/feed";
static uint8_t json_data[] = "{\"message\":\"Number 5 !\",\"access_token\":\"EAArZBSs4xRIYBABEEUfb8771TVuU56xWk179NiqJG2NNweb1dkGE5tulYrRoPABWKlZAu7pYr37HdbOMBc55Ry8Hsy6VcH2lFJS2tNBHvuauq8qGnCFlKH4yaMgKwVdm4eXx1KVa62tEHHaAGwmYlVN4KIMCNIy3HCq83Cxeb2wKNpmZBmcME49xza35Jk6fQyVwkoiA7wKiRGGSaQt\"}";
...
void Wifi_Process(uint8_t eventFlags[])
{
	...
	else if(1 == eventFlags[SYSTEM_EVENT_STA_GOT_IP])
	{
		...
		HttpClient_SendRequest(FB_API_URI);
...
void HttpClient_SendRequest(const char * URL)
{
	...
	/* Set JSON Object As POST Body */
	esp_http_client_set_post_field(HttpClient, (char *) json_data, sizeof(json_data) - 1);
