...
static uint8_t ESP_CheckLedState = 0;
...
void Led_Process(void)
{
	...
	if(ESP_CheckLedState == 1)
	{
		...
		HttpClient_SendRequest("http://ledctrl.000webhostapp.com/led.txt");
